...
public class MyBatisGenerator {
     ...
     * 生成文件所在项目路径
     */
    private static final String BASE_PATH = "D:\\workSpace\\pay";
    /**
     * 基本包名
     */
    private static final String BASE_PACKAGE = "com.yc.pay";
    /**
     * 文件夹名
     */
    private static final String MODEL_NAME = "mapper";
    private static final String AUTHOR = "xieyc";
    /**
     * 要生成的表名
     */
    private static final String[] TABLES = {"mall_pay","mall_order"};
